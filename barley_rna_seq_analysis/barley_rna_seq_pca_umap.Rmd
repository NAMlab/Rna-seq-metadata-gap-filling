...
```{r}
df <- read.delim("my_barley_input.2.part1.abundance.tsv.gz", header = TRUE, sep = "\t")
df1 <- read.delim("my_barley_input.2.part2.abundance.tsv.gz", header = TRUE, sep = "\t")
df2 <- read.delim("my_barley_input.2.part3.abundance.tsv.gz", header = TRUE, sep = "\t")
df3 <- read.delim("my_barley_input.2.part4.abundance.tsv.gz", header = TRUE, sep = "\t")
...
#load your metadata
library(readxl)
meta_raw <- read_xlsx("hordeum_vulgare_10520.(2).xlsx")
...
excel_sheets("hordeum_vulgare_10520.(2).xlsx")
...
meta_raw <- read_xlsx("hordeum_vulgare_10520.(2).xlsx", sheet = "Sheet1")
...
ggsave("pca_barley_developmental_stage_noNA.png", width = 7,
       height = 5, dpi = 300) 
